...
API contracts use persisted UUID resource identifiers. The structure response's `versionId` must be approved and then passed unchanged to execution creation; PoC string aliases are not accepted.
